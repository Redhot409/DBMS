CREATE DATABASE SQL_ACADEMY_FULL
ON
(
	NAME		=SQL_ACADEMY_FULL,
	FILENAME	='D:\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\SQL_ACADEMY_FULL.mdf',
	SIZE		= 8 MB,
	MAXSIZE		= 500 MB,
	FILEGROWTH	= 8 MB
)
LOG ON
(
	NAME		=SQL_ACADEMY_FULL_Log,
	FILENAME	='D:\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\SQL_ACADEMY_FULL_Log.ldf',
	SIZE		= 8 MB,
	MAXSIZE		= 500 MB,
	FILEGROWTH	= 8 MB
)
...
(
	...
	lesson			BIGINT						CONSTRAINT		FK_Grades_Shcedule	FOREIGN KEY	REFERENCES	Schedule(lesson_id),
